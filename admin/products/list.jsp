...
<HEAD>
	...
	<script type="text/javascript">
		...
		function order() {
			window.location.href = "${pageContext.request.contextPath}/findOrders";
		}

		function record() {
			window.location.href = "${pageContext.request.contextPath}/findRecords";
		}
		//删除商品
		function p_del() {
			var msg = "您确定要删除该商品吗？";
			...
			<TBODY>
				...
				<tr>
					<td class="ta_01" align="right">
						<button type="button" value=order; onclick="order()">
							订单
						</button>
					</td>
				</tr>
				<tr>
					<td class="ta_01" align="right">
						<button type="button" value=record; onclick="record()">
							浏览/购买日志
						</button>
					</td>
				</tr>
							...
							<c:forEach items="${ps}" var="p">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%">
									    <a href="${pageContext.request.contextPath}/productdetail?id=${p.id}&type="admin"">
