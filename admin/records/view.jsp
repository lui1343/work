...
<body>
	<table cellSpacing="1" cellPadding="5" width="100%" align="center"
		...
		<tr>
			<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">记录编号：</td>
			<td class="ta_01" bgColor="#ffffff">${record.id}</td>
			<td align="center" bgColor="#f5fafe" class="ta_01">所属用户：</td>
			<td class="ta_01" bgColor="#ffffff">${record.user.username }</td>
		</tr>
		<tr>
			<td align="center" bgColor="#f5fafe" class="ta_01">操作时间：</td>
			<td class="ta_01" bgColor="#ffffff">${record.recordtime}</td>
			<td align="center" bgColor="#f5fafe" class="ta_01">商品编号：</td>
			<td class="ta_01" bgColor="#ffffff">${record.pid }</td>
		</tr>
		<TR>
